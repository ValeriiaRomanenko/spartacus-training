 ...
 */
package com.epam.spartacustraining.fulfilmentprocess.jobs;
...
public class CleanUpFraudOrderJob extends AbstractJobPerformable<CronJobModel>
{
	...
	{
		final String processDefinitionName = SpartacustrainingFulfilmentProcessConstants.ORDER_PROCESS_NAME;
