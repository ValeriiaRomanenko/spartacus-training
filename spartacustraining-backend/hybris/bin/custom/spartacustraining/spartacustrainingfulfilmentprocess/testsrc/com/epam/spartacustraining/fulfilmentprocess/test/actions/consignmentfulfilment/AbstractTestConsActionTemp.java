 ...
 */
package com.epam.spartacustraining.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, SpartacustrainingFulfilmentProcessConstants.PARENT_PROCESS);
