 ...
 */
package com.epam.spartacustraining.fulfilmentprocess.test;
...
import com.epam.spartacustraining.fulfilmentprocess.test.actions.TestActionTemp;
...
public class ProcessFlowTest extends HybrisJUnit4Test
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/spartacustrainingfulfilmentprocess/test/spartacustrainingfulfilmentprocess-spring-test.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/spartacustrainingfulfilmentprocess/test/process/order-process-spring.xml"));
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/spartacustrainingfulfilmentprocess/test/process/consignment-process-spring.xml"));
		...
		definitonFactory.add("classpath:/spartacustrainingfulfilmentprocess/test/process/order-process.xml");
		definitonFactory.add("classpath:/spartacustrainingfulfilmentprocess/test/process/consignment-process.xml");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/spartacustrainingfulfilmentprocess/test/spartacustrainingfulfilmentprocess-spring-testcleanup.xml"));
