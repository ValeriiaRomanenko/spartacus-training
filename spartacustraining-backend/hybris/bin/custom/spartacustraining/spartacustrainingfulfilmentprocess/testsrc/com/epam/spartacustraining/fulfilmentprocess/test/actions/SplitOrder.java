 ...
 */
package com.epam.spartacustraining.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(SpartacustrainingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(SpartacustrainingFulfilmentProcessConstants.PARENT_PROCESS);
