 ...
 */
package com.epam.spartacustraining.storefront.security.impl;
...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/spartacustrainingstorefront/electronics/en",
						"https://electronics.local:9002/spartacustrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/spartacustrainingstorefront/electronics/en",
						"https://electronics.local:9002/spartacustrainingstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/spartacustrainingstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/spartacustrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/spartacustrainingstorefront/electronics/en",
						"https://electronics.local:9002/spartacustrainingstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/spartacustrainingstorefront",
						"https://electronics.local:9002/spartacustrainingstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/spartacustrainingstorefront",
						"https://electronics.local:9002/spartacustrainingstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/spartacustrainingstorefront/electronics/en",
						"https://electronics.local:9002/spartacustrainingstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
