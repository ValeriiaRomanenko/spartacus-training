...
@Component({
  selector: 'st-payment-details',
  templateUrl: './st-payment-details.component.html',
  styleUrls: ['./st-payment-details.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class StPaymentDetailsComponent implements OnInit, OnDestroy {
