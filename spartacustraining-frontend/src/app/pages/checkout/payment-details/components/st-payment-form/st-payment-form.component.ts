...
@Component({
  selector: 'st-payment-form',
  templateUrl: './st-payment-form.component.html',
  styleUrls: ['./st-payment-form.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class StPaymentFormComponent implements OnInit {
  ...
  getControlByBilling(name: string): FormControl {
    return this.billingAddressForm.get(name) as FormControl;
  }

  getControlByPayment(name: string): FormControl {
