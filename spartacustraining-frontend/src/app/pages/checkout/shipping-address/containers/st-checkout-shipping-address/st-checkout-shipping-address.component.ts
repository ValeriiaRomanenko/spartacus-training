...
@Component({
  selector: 'st-checkout-shipping-address',
  templateUrl: './st-checkout-shipping-address.component.html',
  styleUrls: ['./st-checkout-shipping-address.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class StCheckoutShippingAddressComponent implements OnInit, OnDestroy {
